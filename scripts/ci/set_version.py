...
Invoked from CI before the sdist + wheel are built, so the published artifacts
carry the release version taken from the pushed ``v*`` tag instead of whatever
static version happens to be committed.
